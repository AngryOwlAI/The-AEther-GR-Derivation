...
This note is the compact naming reference for the active manuscript sequence of `The Æther-Flow Interpretation of Relativity`.

## Required Names

| Use | Preferred form |
| --- | --- |
| Theory name | `The Æther-Flow Interpretation of Relativity` |
| Substrate | `Æther` |
| Intrinsic motion | `Æther-flow` |
| Observed space | observed three-dimensional space |
| Slice language | local experiential slice |
| Time language | `S-time` |
| Benchmark status | exact closure |
| Use of GR | adoption |
| First-principles recovery | derivation |

Older repository labels are legacy material and should not appear in active prose or active filenames.

## Core Definitions

- `Æther`: the underlying four-dimensional substrate of reality.
- `Æther-flow`: the intrinsic ordered motion of that substrate.
- observed three-dimensional space: the observer-level local experiential slice of the deeper substrate.
...
- exact closure: the benchmark stance in which the operational relativistic sector agrees exactly with GR.
...
- Use the full theory name in titles, opening paragraphs, and high-visibility prose.
- Present the overview-first exact-closure package before the downstream derivational manuscripts.
- Keep `adoption` and `derivation` sharply separated.
...
- The derivational manuscript line is the active research workstream.
...
- The current missing ingredient is the benchmark-closing substrate law that would force the primitive observer-reduction bridge object to yield the adopted benchmark one-metric observer package as a genuine derivation rather than preserved package data. See [GR_DERIVATION_AUDIT_PACKAGE.md](GR_DERIVATION_AUDIT_PACKAGE.md).
...
- the benchmark exact-closure package
...
If there is any conflict between a shorter convenience label and the active theory name, prefer `The Æther-Flow Interpretation of Relativity`.
