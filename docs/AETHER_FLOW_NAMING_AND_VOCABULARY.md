...
- The file map currently carries [aether_flow_bounded_gr_derivation_bridge_object_synthesis.tex](../manuscripts/active/tex/aether_flow_bounded_gr_derivation_bridge_object_synthesis.tex) as the live `active_primary` bounded bridge-object synthesis manuscript.
