...
\begin{enumerate}
    \item \textbf{Standard GR with interpretive language.} Relative to ordinary GR \cite{Einstein1916}, the active benchmark package keeps the same low-energy equations and observable content. The difference is not a second field equation, a new low-energy graviton sector, or a modified matter route. It is the disciplined interpretive overlay supplied by the \Aether{} / \Aflow{} ontology and by the congruence-based geometric reading of that ontology.
    \item \textbf{Einstein-aether theory.} Einstein-aether theory introduces a dynamical unit timelike vector field at observer level and therefore a genuine preferred-frame sector with additional coupled propagating modes \cite{JacobsonMattingly2001,JacobsonMattingly2004}. The active benchmark package does not do that. It claims no surviving observer-level aether vector field, no extra low-energy graviton sector, and no modified Einsteinian observer law.
    \item \textbf{Thermodynamic or other emergent-gravity derivations.} Programs such as Jacobson's derivation of the Einstein equation as an equation of state \cite{Jacobson1995} are closer in ambition to the downstream derivation program than to the benchmark package itself. Their category is a derivational explanation of GR, not an exact-GR interpretive package already separated from its open derivation burden.
    \item \textbf{Sakharov-style induced gravity.} Sakharov-style induced-gravity proposals likewise ask how the Einstein-Hilbert sector may arise effectively from deeper microphysics \cite{Sakharov1967}. That is conceptually adjacent to the project's open foundational ambition, but it is not the same as claiming that such an induced derivation has already been completed here.
    \item \textbf{Ho\v{r}ava gravity and other preferred-foliation alternatives.} Ho\v{r}ava gravity proposes a different dynamical framework with preferred foliation structure and altered mode content, even when it is designed to approach relativistic behavior in an infrared limit \cite{Horava2009}. The active benchmark package is not of that type, because its operational content is exactly GR rather than a modified low-energy gravity law awaiting experimental separation from GR.
\end{enumerate}
...
\begin{remark}
Representative comparison points are Einstein's formulation of GR, Einstein-aether theory, Jacobson's thermodynamic derivation of the Einstein equation, Sakharov-style induced gravity, and Ho\v{r}ava gravity \cite{Einstein1916,JacobsonMattingly2001,JacobsonMattingly2004,Jacobson1995,Sakharov1967,Horava2009}.
\end{remark}
