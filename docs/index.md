...
The benchmark starting point is the overview-first exact-closure package centered on [`aether_flow_exact_closure_sequence_overview.tex`](assets/tex/aether_flow_exact_closure_sequence_overview.tex). That package remains the active theory statement at the operational level. As of March 31, 2026, the repository goal goes one step further: the current research program aims to derive that same GR sector from the `Æther / Æther-flow` framework without changing the benchmark claim boundary prematurely.

## Current Research Status

- The benchmark exact-closure package remains the fixed public front door.
- The live benchmark-facing sequence now runs from the derivation-gates note through the exact-preservation root-shell, primitive-substrate, subprimitive-substrate, proto-subprimitive-substrate, pre-proto-subprimitive stationary-selection, stationary-selection forcing-principle, and forcing-principle primitive-reservoir / stationary-reduction origin notes on the one-metric charge-polarization line.
- The immediate next primary manuscript target is now one layer below that new forcing-principle primitive-reservoir / stationary-reduction note: derive or justify why the deeper primitive-reservoir bundles, their exact primitive-reservoir sections and functionals, their lifted forcing / selection / proto-subprimitive-generating / subprimitive-generating / primitive-generating / root-generating / pre-ambient-generating / ambient-generating / shell / exact-constraint maps, their primitive-reservoir cotangent-model Liouville one-forms / closed two-form geometry, their primitive-reservoir connection one-forms / parallel transports, and their primitive-reservoir-basic source / action data themselves arise, while preserving the same forcing-principle, stationary-selection, pre-proto-subprimitive, proto-subprimitive, subprimitive, primitive, root, pre-ambient, ambient-shell, process-state, and reversible-chain package, the same \(\StemFunctional\), the same exact-preservation normal form, the same carrier-origin / primitive-reservoir / microscopic-equilibrium functionals, the same \(\Sigma^{\mathrm{cmp}}\) solve, the same \(\Pi_{\mathrm{free}}H=0\) outcome, the same observer-equation closure, the same one operative metric, and the recorded Phase D / E and Phase F gains.
