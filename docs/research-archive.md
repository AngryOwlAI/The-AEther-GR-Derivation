...
The live derivational target after the benchmark package is now a midpoint/fiber origin or selection note below the recorded orbit-shape/modulus burden-fixing note, primitive-class setup note, primitive-class amplitude-lift note, amplitude-sector origin note, and absolute-amplitude/polarity origin note.
...
The next active work is no longer another archive or presentation edit, it is no longer the direct-vs-setup decision, it is no longer the first direct derivational `.tex` manuscript below the setup layer, it is no longer the amplitude-sector origin manuscript below the amplitude-lift layer, and it is no longer the absolute-amplitude/polarity origin manuscript below the amplitude-sector layer. Those steps are already recorded. The next active work is a midpoint/fiber origin or selection manuscript below the absolute-amplitude/polarity layer.

- Use [aether_flow_substrate_higher_derivative_nonlocal_bridge_self_response_off_shell_profile_selection_bridge_order_orbit_shape_modulus_primitive_class_absolute_amplitude_polarity_origin_note.tex](../manuscripts/active/tex/aether_flow_substrate_higher_derivative_nonlocal_bridge_self_response_off_shell_profile_selection_bridge_order_orbit_shape_modulus_primitive_class_absolute_amplitude_polarity_origin_note.tex) together with the setup, amplitude-lift, and amplitude-sector notes as the launch point.
- Draft the next still-deeper manuscript that derives or sharply constrains the midpoint/fiber data or a canonical representative feeding that absolute-amplitude/polarity note, defines the map into the recorded absolute-amplitude/polarity layer and hence through the already-frozen downstream maps, proves that the same raw-orbit lift and same downstream chain remain unchanged, and revisits the scale-orbit or residual vacuum-angle verdicts only if genuinely deeper quotient or locking structure appears.
