...
- Treat the file map as now carrying [aether_flow_bounded_gr_derivation_bridge_object_synthesis.tex](../manuscripts/active/tex/aether_flow_bounded_gr_derivation_bridge_object_synthesis.tex) as the live `active_primary` bounded bridge-object synthesis manuscript; the former source-penalty-kernel relay endpoint remains preserved as historical context rather than live frontier status.
