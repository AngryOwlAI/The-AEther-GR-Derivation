...
\begin{enumerate}
    \item Relative to standard GR \cite{Einstein1916}, the benchmark package keeps the same low-energy equations and observable content. The difference is interpretive ontology and package discipline, not a second low-energy field law.
    \item Relative to Einstein-aether theory and Ho\v{r}ava gravity \cite{JacobsonMattingly2001,JacobsonMattingly2004,Horava2009}, the package is not a preferred-frame modification with a surviving observer-level vector or foliation field and extra propagating modes.
    \item Relative to thermodynamic or induced-gravity programs \cite{Jacobson1995,Sakharov1967}, the package is closer in spirit only at the level of the downstream derivation ambition: those programs ask how Einsteinian gravity emerges from deeper structure, just as the open derivational line here asks a related foundational question.
\end{enumerate}
