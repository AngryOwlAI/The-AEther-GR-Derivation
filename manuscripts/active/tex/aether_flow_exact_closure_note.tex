...
That is the correct current status of \TheoryName{}. It is not a placeholder waiting to be replaced. It is the completed GR-consistent theory developed in the exact-closure note. Inside the flagship package, the overview is the front door, this note is the short anchor, the five companion papers supply the modular full statement, and the flagship public article is a release-facing synthesis built on that same order. In that public-facing architecture, exact closure is stated first, the current bounded derivation line is read as a scoped no-go on its frozen bridge object, and any later derivational continuation remains answerable to the benchmark package as secondary foundational work on a genuinely new line.
