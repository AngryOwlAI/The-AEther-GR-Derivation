...
The benchmark exact-closure package remains the fixed public front door of the repository. The live derivational objective, as of March 26, 2026, is the deeper observer-equation redesign for the recorded charge-polarization candidate after the benchmark-gates, observer-remainder, redesign-screen, infrared-spectrum, controlled-GR-limit, and residual-sector-verdict notes already in hand. That next note must handle the surviving finite-\(\varepsilon\) composite quartic residual sector away from the decisive exterior cancellation regime without giving back the one operative metric or the recorded Phase D / E and Phase F gains. The deeper anchored positive-pair continuation remains recorded side work unless it changes the observer equation or the current scale-orbit / residual-vacuum-angle verdicts.
...
- The first explicit charge-polarization candidate, the full infrared-spectrum / universal-coupling gate note, the controlled GR-limit note, and the residual-sector verdict note are now recorded.
- The next primary research step is a deeper observer-equation redesign on that same line, removing or reclassifying the surviving composite quartic residual sector as absent, gauge exact, constraint exact, or genuinely decoupled away from the decisive exterior cancellation regime while preserving the recorded one-operative-metric, Phase D / E, and Phase F gains.
- Stronger promotion language should wait until that residual sector has been handled cleanly.
