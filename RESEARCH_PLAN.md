...
This file is intentionally short. It tracks the live control surface for `The Æther-Flow Interpretation of Relativity` after the current-line obstruction verdict and after the benchmark package was promoted as the flagship result.
...
- Keep the routing question fixed: any resumed derivational work must begin on a genuinely new line rather than by descending again below the same frozen bridge object, and it must first complete the charter concretely at equation level.
...
- Do not reopen derivation on the strength of outside-review return alone; only a candidate line that already completes the new-line charter concretely at the level of equations, local maps, metric generation, mode control, relativistic recovery, and verdict rule may reopen the question.
...
The previous long-form completed-task ledger has been moved to:

- [docs/_archived_plans/2026-04-research-plan-history-ledger.md](docs/_archived_plans/2026-04-research-plan-history-ledger.md)
