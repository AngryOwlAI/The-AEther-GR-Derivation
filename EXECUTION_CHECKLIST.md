...
- [ ] Treat the preserved source-penalty-kernel relay endpoint and related same-output relays as historical context, not as standing instructions that the default next move is simply to go one level deeper.

## Current Primary Research Rule

- [ ] Do not reopen the frozen line by another same-package observer-side rewrite or another same-output deeper relay preserving the same benchmark-facing compressed core.
...
- [x] The primitive-reservoir bridge-entry and bridge-object support theorems already on record remain supporting benchmark-facing context.
